            ...
            {index > 0 && (
                <Group justify="space-between" align="center">
                    ...
                    <ActionIcon
                        ...
                        variant="subtle"
                        onClick={() =>
                            form.removeListItem("officerOfCorporations", index)
                        }
                    >
                        <IconTrash size="1rem" />
                    </ActionIcon>
            ...
            <Box>
                ...
                <SimpleGrid cols={2}>
                    <TextInput
                        label="First Name"
                        {...form.getInputProps(
                            `officerOfCorporations.${index}.firstName`
                        )}
                    />
                    <TextInput
                        label="Middle Name"
                        {...form.getInputProps(
                            `officerOfCorporations.${index}.middleName`
                        )}
                    />
                    <TextInput
                        label="Last Name"
                        {...form.getInputProps(
                            `officerOfCorporations.${index}.lastName`
                        )}
                    />
        ...
        <StepperFormLayout>
            <Stack gap="lg">
                ...
                {form.values.isBylawsAndMinuteBook === "YES" && (
                    <Box>
                        <Title order={6} mb={"xs"}>Officer’s Information</Title>
                        {fields.slice(0, 1)}
                ...
                {form.values.isBylawsAndMinuteBook === "NO" && (
                    <Alert
                        ...
                        icon={<IconInfoCircle />}
                    >
                        You&apos;re skipping the following information as you
                        didn&apos;t select MinuteBook & Bylaws.
                        <List listStyleType="decimal">
                            <List.Item>Shareholder(s)</List.Item>
                            <List.Item>Share Number(s) & Price(s)</List.Item>
                            <List.Item>
                                Officer(s) & Officer(s) Designation
                            </List.Item>
                        </List>
                    </Alert>
                )}
